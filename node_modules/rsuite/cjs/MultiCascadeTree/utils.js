 ...
 * @param itemKeys
 */
var isSomeChildChecked = exports.isSomeChildChecked = function isSomeChildChecked(node, value, itemKeys) {
 ...
 * @param itemKeys
 */
var isSomeParentChecked = exports.isSomeParentChecked = function isSomeParentChecked(node, value, itemKeys) {
 ...
 */
var removeAllChildrenValue = exports.removeAllChildrenValue = function removeAllChildrenValue(value, item, itemKeys) {
  var valueKey = itemKeys.valueKey,
    childrenKey = itemKeys.childrenKey;
  var removedValue = [];
  if (!item[childrenKey]) {
