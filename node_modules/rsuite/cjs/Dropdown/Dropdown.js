...
var Dropdown = /*#__PURE__*/_react.default.forwardRef(function (props, ref) {
  ...
  var _rest$as = rest.as,
    ...
    style = rest.style,
    toggleProps = (0, _objectWithoutPropertiesLoose2.default)(rest, _excluded2);
  ...
  return /*#__PURE__*/_react.default.createElement(_DropdownContext.default.Provider, {
    ...
    renderMenuPopup: function renderMenuPopup(_ref, popupRef) {
      var open = _ref.open,
        popupProps = (0, _objectWithoutPropertiesLoose2.default)(_ref, _excluded3);
    ...
    var open = _ref2.open,
      menuContainer = (0, _objectWithoutPropertiesLoose2.default)(_ref2, _excluded4);
